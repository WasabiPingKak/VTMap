...
const ROWS: ParamRow[] = [
  ...
  { key: "hop3CapMultiplier", label: "hop3 半徑上限倍率", min: 0.5, max: 2, step: 0.05, hint: "× ringRadii[3]" },
  { key: "outerCapMultiplier", label: "外圍半徑上限倍率", min: 0.3, max: 2, step: 0.05, hint: "× ringRadii[4],< 1 把灰點拉近" },
];
